  ...
  return (
    <div className="flex items-center justify-center gap-4">
      ...
      {config.oauth.google.clientId && (
        <div className={`${disabled || isLoading ? 'pointer-events-none opacity-50' : ''}`}>
          <GoogleLogin
      ...
      {config.oauth.facebook.appId && (
        <Button
          ...
          className="h-10 w-10 rounded-full hover:bg-[#1877F2] hover:border-[#1877F2] border-gray-300 transition-colors"
